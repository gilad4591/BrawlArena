...
const HE = {
  ...
  'Drag the joystick (or press the arrow keys) to walk around.': 'גרור את הג׳ויסטיק (או השתמש בחצים) כדי לזוז.',
  'Tap ▲ (or press W) to jump.': 'הקש ▲ (או W) כדי לקפוץ.',
  'Tap HIT (or press A) to throw a punch.': 'הקש HIT (או A) כדי לתת מכה.',
  'Tap SP (or press S) to unleash your special attack.': 'הקש SP (או S) כדי לשלוח מתקפה מיוחדת.',
  'Hold DEF (or press D) to block an incoming hit.': 'החזק DEF (או D) כדי לחסום מכה נכנסת.',
  'All Set!': 'הכל מוכן!',
  "You're ready to fight — pick your character and go!": 'אתה מוכן להילחם — בחר דמות וזנוק לקרב!',
  'Skip Tutorial ✕': 'דלג על המדריך ✕',
  '📤 Share': '📤 שתף',
  "Couldn't share — try again": 'השיתוף נכשל — נסה שוב',
  'I just won a match in Brawl Arena! {meta}': 'רק ניצחתי במשחק בברול ארנה! {meta}',
  'Brawl Arena — {meta}': 'ברול ארנה — {meta}',
  Matches: 'משחקים',
  Wins: 'נצחונות',
  ...
  'Special FX — supercharged special-attack projectiles': 'אפקט מתקפה — קליעים מיוחדים משודרגים ומרשימים',
  'Each fighter wears its own element': 'לכל לוחם יש אלמנט משלו',
  'Choose a fighter to customise': 'בחר לוחם להתאמה אישית',
  Fighters: 'לוחמים',
  Owned: 'ברשותך',
  'Music Track': 'רצועת מוזיקה',
  'Arena Anthem': 'המנון הזירה',
  'Warm & heroic': 'חמים וגיבורי',
  'Neon Drift': 'נאון דריפט',
  'Energetic & driving': 'אנרגטי וקצבי',
  'Shadow Pulse': 'פעימת צללים',
  'Dark & tense': 'אפל ומותח',
