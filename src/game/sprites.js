...
export const SPRITE_DEFS = {
  ...
  // High-res hand-authored fire warrior (Blaze). 30 extracted poses; full walk
  // + idle-flicker cycles. Frame indices map into sprites/fire.frames.json.
  blaze: {
    sheet: 'sprites/fire.png',
    frames: 'sprites/fire.frames.json',
    scale: 0.95,
    faceRight: true,
    portraitFrame: 0,
    portraitZoom: 1.15,
    animations: {
      ...
      attack: { frames: [16, 18], fps: 10, loop: false },
      special: { frames: [19], loop: false },
      hit: { frames: [29], loop: false },
  ...
  aurex: {
    sheet: 'sprites/aurex.png', frames: 'sprites/aurex.frames.json', scale: 0.95,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.12,
    animations: {
      idle: { frames: [0, 1, 2, 3], fps: 4, loop: true },
      walk: { frames: [8, 9, 10, 11], fps: 9, loop: true },
      jump: { frames: [12], loop: false },
      attack: { frames: [15, 18], fps: 10, loop: false },
      special: { frames: [19], loop: false },
      hit: { frames: [38], loop: false },
      defend: { frames: [0], loop: false },
      ko: { frames: [38], loop: false },
    },
  },
  shade: {
    sheet: 'sprites/shade.png', frames: 'sprites/shade.frames.json', scale: 0.95,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.12,
    animations: {
      idle: { frames: [0, 1, 2, 3], fps: 4, loop: true },
      walk: { frames: [8, 9, 10, 11], fps: 9, loop: true },
      jump: { frames: [12], loop: false },
      attack: { frames: [16, 18], fps: 11, loop: false },
      special: { frames: [28], loop: false },
      hit: { frames: [34], loop: false },
      defend: { frames: [0], loop: false },
      ko: { frames: [34], loop: false },
    },
  },
  golem: {
    sheet: 'sprites/golem.png', frames: 'sprites/golem.frames.json', scale: 0.98,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.05,
    animations: {
      idle: { frames: [0, 1, 2, 3], fps: 3, loop: true },
      walk: { frames: [8, 9, 10, 11], fps: 8, loop: true },
      jump: { frames: [12], loop: false },
      attack: { frames: [16, 17], fps: 8, loop: false },
      special: { frames: [19], loop: false },
      hit: { frames: [31], loop: false },
      defend: { frames: [0], loop: false },
      ko: { frames: [34], loop: false },
    },
  },
  ...
  nox: {
    sheet: 'sprites/nox.png', frames: 'sprites/nox.frames.json', scale: 0.95,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.12,
    animations: {
      idle: { frames: [0, 1, 2, 3], fps: 4, loop: true },
      walk: { frames: [8, 9, 10, 11], fps: 9, loop: true },
      jump: { frames: [14], loop: false },
      attack: { frames: [16, 18], fps: 10, loop: false },
      special: { frames: [27], loop: false },
      hit: { frames: [34], loop: false },
      defend: { frames: [24], loop: false },
      ko: { frames: [34], loop: false },
    },
  },
  volt: {
    sheet: 'sprites/volt.png', frames: 'sprites/volt.frames.json', scale: 0.95,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.12,
    animations: {
      idle: { frames: [0, 1, 2], fps: 4, loop: true },
      walk: { frames: [3, 4, 5, 6], fps: 10, loop: true },
      jump: { frames: [8], loop: false },
      attack: { frames: [12, 14], fps: 12, loop: false },
      special: { frames: [15], loop: false },
      hit: { frames: [24], loop: false },
      defend: { frames: [0], loop: false },
      ko: { frames: [26], loop: false },
    },
  },
  sylva: {
    sheet: 'sprites/sylva.png', frames: 'sprites/sylva.frames.json', scale: 0.95,
    faceRight: true, portraitFrame: 0, portraitZoom: 1.12,
    animations: {
      idle: { frames: [0, 1, 2, 3], fps: 4, loop: true },
      walk: { frames: [8, 9, 10, 11], fps: 9, loop: true },
      ...
      hit: { frames: [30], loop: false },
      defend: { frames: [0], loop: false },
      ko: { frames: [30], loop: false },
    },
  },
  sage: {
